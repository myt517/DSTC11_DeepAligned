...
class KmeansModelManager:
    ...
    def __init__(self, args, data, pretrained_model=None):
        ...
        self.model = BertForModel.from_pretrained(args.bert_model, num_labels=data.n_unknown_cls)
    ...
    def save_results(self, args):
        ...
        file_name = 'results_analysis_V4_2.csv'
    ...
    def save_results_2(self, args):
        ...
        file_name = 'results_analysis_V4_4_intra_inter.csv'
        results_path = os.path.join(args.save_results_path, file_name)
