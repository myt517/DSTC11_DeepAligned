...
def init_model():
    ...
    parser.add_argument("--save_results_path", type=str, default='outputs_v6', help="The path to save results.")
    
    parser.add_argument("--pretrain_dir", default='pretrain_models_v2', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")

    parser.add_argument("--model_dir", default='models_v2', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    ...
    parser.add_argument('--seed2', type=int, default=0, help="Random seed for initialization.")
